...
REST_FRAMEWORK = {
    'DEFAULT_PAGINATION_CLASS': 'industrial_designs.pagination.FlexiblePageNumberPagination',
    'PAGE_SIZE': 50,
    'DEFAULT_FILTER_BACKENDS': [
        'django_filters.rest_framework.DjangoFilterBackend'
    ],
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': os.getenv('DB_NAME', 'IndustrialDesign'),
        'USER': os.getenv('DB_USER', 'Azhari'),
        'PASSWORD': os.getenv('DB_PASSWORD', 'CIPO'),
