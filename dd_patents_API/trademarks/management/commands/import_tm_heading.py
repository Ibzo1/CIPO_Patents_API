...
from trademarks.models import TM_Heading
...
class Command(BaseCommand):
    help = "Import TM_Heading data from a ZIP file containing a CSV."

    ZIP_FILE_PATH = "C:/Users/Intern_1/Documents/TM_Data/TM_heading_2024-11-20.zip"
    ...
    def process_csv(self, file_path):
        ...
        with open(file_path, 'r', encoding='utf-8') as csvfile:
            ...
            for row in reader:
                ...
                if cleaned:
                    entries.append(TM_Heading(**cleaned))
                count += 1
                if count % BATCH_SIZE == 0:
                    with transaction.atomic():
                        TM_Heading.objects.bulk_create(entries, ignore_conflicts=True)
    ...
    def clean_row(self, row):
        ...
        for key, value in row.items():
            ...
            if norm_key in self.CSV_TO_MODEL_MAP:
                ...
                if model_field in ["application_number", "index_heading_number"]:
                    try:
                        cleaned[model_field] = int(value) if value else None
